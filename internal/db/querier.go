...
type Querier interface {
	...
	ListEntries(ctx context.Context, userID int64) ([]ListEntriesRow, error)
	ListEntriesByDay(ctx context.Context, arg ListEntriesByDayParams) ([]ListEntriesByDayRow, error)
